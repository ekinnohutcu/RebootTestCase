...
namespace Lean.Touch
{
	...
	public class LeanDragTranslateXZ : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			var position = oldPosition + remainingTranslation - newRemainingTranslation;
			transform.localPosition = new Vector3(position.x , transform.localPosition.y, position.z);
